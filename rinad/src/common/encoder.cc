...
const std::string EncoderConstants::DIRECTORY_FORWARDING_TABLE_ENTRIES =
...
const std::string EncoderConstants::NMINUSONEFLOWMANAGER =
...
const std::string EncoderConstants::FLOWSTATEOBJECTGROUP =
		"flowstateobjectgroup";
const std::string EncoderConstants::OPERATIONAL_STATUS_RIB_OBJECT_NAME =
		SEPARATOR + DAF + SEPARATOR + MANAGEMENT + SEPARATOR
				+ OPERATIONAL_STATUS;
const std::string EncoderConstants::OPERATIONAL_STATUS_RIB_OBJECT_CLASS =
		"operationstatus";
const std::string EncoderConstants::PDU_FORWARDING_TABLE_RIB_OBJECT_CLASS =
		"pdu forwarding table";
const std::string EncoderConstants::PDU_FORWARDING_TABLE_RIB_OBJECT_NAME =
		SEPARATOR + DIF + SEPARATOR + RESOURCE_ALLOCATION + SEPARATOR
				+ PDU_FORWARDING_TABLE;
const std::string EncoderConstants::DIF_REGISTRATION_SET_RIB_OBJECT_CLASS =
		"DIF registration set";
const std::string EncoderConstants::DIF_REGISTRATION_RIB_OBJECT_CLASS =
		"DIF registration";
const std::string EncoderConstants::DIF_REGISTRATION_SET_RIB_OBJECT_NAME =
		SEPARATOR + DIF + SEPARATOR + RESOURCE_ALLOCATION + SEPARATOR
				+ NMINUSONEFLOWMANAGER + SEPARATOR + DIF_REGISTRATIONS;
const std::string EncoderConstants::N_MINUS_ONE_FLOW_SET_RIB_OBJECT_CLASS =
		"nminusone flow set";
const std::string EncoderConstants::N_MINUS_ONE_FLOW_RIB_OBJECT_CLASS =
		"nminusone flow";
const std::string EncoderConstants::N_MINUS_ONE_FLOW_SET_RIB_OBJECT_NAME =
		SEPARATOR + DIF + SEPARATOR + RESOURCE_ALLOCATION + SEPARATOR
				+ NMINUSONEFLOWMANAGER + SEPARATOR + NMINUSEONEFLOWS;
const std::string EncoderConstants::WHATEVERCAST_NAME_SET_RIB_OBJECT_NAME =
		SEPARATOR + DAF + SEPARATOR + MANAGEMENT + SEPARATOR + NAMING
				+ SEPARATOR + WHATEVERCAST_NAMES;
const std::string EncoderConstants::WHATEVERCAST_NAME_SET_RIB_OBJECT_CLASS =
		"whatname set";
const std::string EncoderConstants::WHATEVERCAST_NAME_RIB_OBJECT_CLASS =
		"whatname";
...
const std::string EncoderConstants::DFT_ENTRY_SET_RIB_OBJECT_CLASS =
		"directoryforwardingtableentry set";
const std::string EncoderConstants::DFT_ENTRY_RIB_OBJECT_CLASS =
		"directoryforwardingtableentry";
const std::string EncoderConstants::FLOW_SET_RIB_OBJECT_NAME = SEPARATOR + DIF
		+ SEPARATOR + RESOURCE_ALLOCATION + SEPARATOR + FLOW_ALLOCATOR
		+ SEPARATOR + FLOWS;
...
const std::string EncoderConstants::QOS_CUBE_SET_RIB_OBJECT_NAME = SEPARATOR
		+ DIF + SEPARATOR + MANAGEMENT + SEPARATOR + FLOW_ALLOCATOR + SEPARATOR
		+ QOS_CUBES;
const std::string EncoderConstants::QOS_CUBE_SET_RIB_OBJECT_CLASS =
		"qoscube set";
const std::string EncoderConstants::QOS_CUBE_RIB_OBJECT_CLASS = "qoscube";
const std::string EncoderConstants::ENROLLMENT_INFO_OBJECT_NAME = SEPARATOR
		+ DAF + SEPARATOR + MANAGEMENT + SEPARATOR + ENROLLMENT;

/// CLASS Encoder
Encoder::~Encoder() {
	for (std::map<std::string, EncoderInterface*>::iterator it =
			encoders_.begin(); it != encoders_.end(); ++it) {
		delete it->second;
		it->second = 0;
	}
	encoders_.clear();
}
void Encoder::addEncoder(const std::string& object_class,
		EncoderInterface *encoder) {
	encoders_.insert(
			std::pair<std::string, EncoderInterface*>(object_class, encoder));
}
const rina::SerializedObject* Encoder::encode(const void* object,
		const std::string& object_class) {
	EncoderInterface* encoder = encoders_[object_class];
	return encoder->encode(object);
}
void* Encoder::decode(const rina::SerializedObject &serialized_object,
		const std::string& object_class) {
	EncoderInterface* encoder = encoders_[object_class];
