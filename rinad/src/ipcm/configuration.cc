...
;
                ...
                // TODO: NMinusOneFlowsConfiguration nMinusOneFlowsConfiguration;
                // TODO: std::list<ExpectedApplicationRegistration> expectedApplicationRegistrations;
                // TODO: std::list<DirectoryEntry> directory;
                // TODO: std::list<KnownIPCProcessAddress> knownIPCProcessAddresses;
                // TODO: rina::PDUFTableGeneratorConfiguration pdufTableGeneratorConfiguration;
                ...
                if (params != 0) {
                        ...
                        for (unsigned int j = 0; j < members.size(); j++) {
                                ...
                                ipc.parameters.insert
                                        (pair<string, string>(members[i], value));
                        }
                }
        ...
        if (appToDIF != 0) {
                for (unsigned int i = 0; i < appToDIF.size(); i++) {
                        ...
                        applicationToDIFMappings.insert
                                (pair<string, rina::ApplicationProcessNamingInformation>
