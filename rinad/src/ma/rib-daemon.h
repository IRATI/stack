...
#ifndef __RINAD_RIBDAEMON_H__
#define __RINAD_RIBDAEMON_H__
...
class MARIBDaemon: public rina::RIBDaemon {
public:
	MARIBDaemon (const rina::RIBSchema *schema);
