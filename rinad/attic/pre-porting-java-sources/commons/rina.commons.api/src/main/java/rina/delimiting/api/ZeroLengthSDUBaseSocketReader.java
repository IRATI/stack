 ...
 *
 */
public abstract class ZeroLengthSDUBaseSocketReader implements Runnable{

	private static final Log log = LogFactory.getLog(ZeroLengthSDUBaseSocketReader.class);
	...
	public ZeroLengthSDUBaseSocketReader(Socket socket, Delimiter delimiter){
		this.socket = socket;
	...
	/**
	 * Process the 0 length SDU that has been received
	 */
	public abstract void process0LengthSDU();
