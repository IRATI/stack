...
inline static uint_t dtcp_pdus_per_time_unit(struct dtcp * dtcp)
{ dtcp_getter(uint_t, pdus_per_time_unit); }

inline static uint_t dtcp_time_unit(struct dtcp * dtcp)
...
inline static int last_rcv_ctrl_seq_set(struct dtcp * dtcp,
...
inline static void flow_ctrl_inc(struct dtcp * dtcp)
{
        ASSERT(dtcp);
        ASSERT(dtcp->sv);
...
inline static void acks_inc(struct dtcp * dtcp)
{
        ASSERT(dtcp);
        ASSERT(dtcp->sv);
...
inline static int snd_rt_wind_edge_set(struct dtcp * dtcp, seq_num_t new_rt_win)
...
inline int rcvr_rt_wind_edge_set(struct dtcp * dtcp, seq_num_t rt_win_edge)
...
inline static seq_num_t next_snd_ctl_seq(struct dtcp * dtcp)
{
        seq_num_t     tmp;
...
inline static seq_num_t last_snd_data_ack(struct dtcp * dtcp)
{ dtcp_getter(seq_num_t, last_snd_data_ack); }

inline static seq_num_t last_rcv_data_ack(struct dtcp * dtcp)
{ dtcp_getter(seq_num_t, last_rcv_data_ack); }

inline static void last_snd_data_ack_set(struct dtcp * dtcp, seq_num_t seq_num)
{
	ASSERT(dtcp);
	ASSERT(dtcp->sv);
...
inline static uint_t dtcp_sndr_credit(struct dtcp * dtcp)
...
inline void update_credit_and_rt_wind_edge(struct dtcp * dtcp, uint_t credit)
{
        ASSERT(dtcp);
        ASSERT(dtcp->sv);
...
inline seq_num_t dtcp_rcv_rt_win(struct dtcp * dtcp)
{ return rcvr_rt_wind_edge(dtcp); }
EXPORT_SYMBOL(dtcp_rcv_rt_win);

inline int dtcp_rcv_rt_win_set(struct dtcp * dtcp, seq_num_t rt_win_edge)
{ return rcvr_rt_wind_edge_set(dtcp, rt_win_edge); }
EXPORT_SYMBOL(dtcp_rcv_rt_win_set);

inline seq_num_t dtcp_snd_rt_win(struct dtcp * dtcp)
{ return snd_rt_wind_edge(dtcp); }
EXPORT_SYMBOL(dtcp_snd_rt_win);

inline int dtcp_snd_rt_win_set(struct dtcp * dtcp, seq_num_t rt_win_edge)
{ return snd_rt_wind_edge_set(dtcp, rt_win_edge); }
EXPORT_SYMBOL(dtcp_snd_rt_win_set);

inline seq_num_t dtcp_snd_lf_win(struct dtcp * dtcp)
