...
namespace rina
{
  ...
  const std::string RIBObjectNames::DIRECTORY_FORWARDING_TABLE_ENTRIES =
  ...
  const std::string RIBObjectNames::NMINUSONEFLOWMANAGER =
  ...
  const std::string RIBObjectNames::FLOWSTATEOBJECTGROUP =
      "flowstateobjectgroup";
  const std::string RIBObjectNames::OPERATIONAL_STATUS_RIB_OBJECT_NAME =
      RIBObjectNames::SEPARATOR + RIBObjectNames::DAF
          + RIBObjectNames::SEPARATOR + RIBObjectNames::MANAGEMENT
          + RIBObjectNames::SEPARATOR + RIBObjectNames::OPERATIONAL_STATUS;

  const std::string RIBObjectNames::OPERATIONAL_STATUS_RIB_OBJECT_CLASS =
      "operationstatus";

  const std::string RIBObjectNames::PDU_FORWARDING_TABLE_RIB_OBJECT_CLASS =
      "pdu forwarding table";
  const std::string RIBObjectNames::PDU_FORWARDING_TABLE_RIB_OBJECT_NAME =
      RIBObjectNames::SEPARATOR + RIBObjectNames::DIF
          + RIBObjectNames::SEPARATOR + RIBObjectNames::RESOURCE_ALLOCATION
          + RIBObjectNames::SEPARATOR + RIBObjectNames::PDU_FORWARDING_TABLE;

  /* CLASS ASSIGN TO DIF REQUEST EVENT */
  AssignToDIFRequestEvent::AssignToDIFRequestEvent(
      const DIFInformation& difInformation, unsigned int sequenceNumber) :
  ...
  UpdateDIFConfigurationRequestEvent::UpdateDIFConfigurationRequestEvent(
      const DIFConfiguration& difConfiguration, unsigned int sequenceNumber) :
  ...
  IPCProcessDIFRegistrationEvent::IPCProcessDIFRegistrationEvent(
      ...
      const ApplicationProcessNamingInformation& difName, bool registered,
      unsigned int sequenceNumber) :
      IPCEvent(IPC_PROCESS_DIF_REGISTRATION_NOTIFICATION, sequenceNumber)
  {
  ...
  bool
  IPCProcessDIFRegistrationEvent::isRegistered() const
  {
    return registered;
  }
  ...
  const std::string&
  QueryRIBRequestEvent::getObjectClass() const
  {
    return objectClass;
  }

  const std::string&
  QueryRIBRequestEvent::getObjectName() const
  {
    return objectName;
  }

  long
  QueryRIBRequestEvent::getObjectInstance() const
  {
    return objectInstance;
  }

  int
  QueryRIBRequestEvent::getScope() const
  {
    return scope;
  }

  const std::string&
  QueryRIBRequestEvent::getFilter() const
  {
    return filter;
  }
  ...
  CreateConnectionResponseEvent::CreateConnectionResponseEvent(int portId,
      ...
      IPCEvent(IPC_PROCESS_CREATE_CONNECTION_RESPONSE, sequenceNumber)
  {
    this->cepId = cepId;
    this->portId = portId;
  }
  ...
  int
  CreateConnectionResponseEvent::getCepId() const
  {
    return cepId;
  }

  int
  CreateConnectionResponseEvent::getPortId() const
  {
    return portId;
  }
  ...
  UpdateConnectionResponseEvent::UpdateConnectionResponseEvent(int portId,
      ...
      IPCEvent(IPC_PROCESS_UPDATE_CONNECTION_RESPONSE, sequenceNumber)
  {
    this->result = result;
    this->portId = portId;
  }
  ...
  int
  UpdateConnectionResponseEvent::getResult() const
  {
    return result;
  }

  int
  UpdateConnectionResponseEvent::getPortId() const
  {
    return portId;
  }
  ...
  CreateConnectionResultEvent::CreateConnectionResultEvent(int portId,
      ...
      IPCEvent(IPC_PROCESS_CREATE_CONNECTION_RESULT, sequenceNumber)
  {
  ...
  int
  CreateConnectionResultEvent::getSourceCepId() const
  {
    return sourceCepId;
  }

  int
  CreateConnectionResultEvent::getDestCepId() const
  {
    return destCepId;
  }

  int
  CreateConnectionResultEvent::getPortId() const
  {
    return portId;
  }
  ...
  DestroyConnectionResultEvent::DestroyConnectionResultEvent(int portId,
      int result, unsigned int sequenceNumber) :
      IPCEvent(IPC_PROCESS_DESTROY_CONNECTION_RESULT, sequenceNumber)
  {
    this->result = result;
    this->portId = portId;
  }
  ...
  int
  DestroyConnectionResultEvent::getResult() const
  {
    return result;
  }

  int
  DestroyConnectionResultEvent::getPortId() const
  {
    return portId;
  }

  /* CLASS DUMP PDU FT RESULT EVENT*/
  DumpFTResponseEvent::DumpFTResponseEvent(
      const std::list<PDUForwardingTableEntry>& entries, int result,
      unsigned int sequenceNumber) :
      IPCEvent(IPC_PROCESS_DUMP_FT_RESPONSE, sequenceNumber)
  {
  ...
  int
  DumpFTResponseEvent::getResult() const
  {
    return result;
  }
  ...
  const DIFInformation&
  ExtendedIPCManager::getCurrentDIFInformation() const
  {
    return currentDIFInformation;
  }

  void
  ExtendedIPCManager::setCurrentDIFInformation(
  ...
  unsigned short
  ExtendedIPCManager::getIpcProcessId() const
  {
    return ipcProcessId;
  }

  void
  ExtendedIPCManager::setIpcProcessId(unsigned short ipcProcessId)
  {
    this->ipcProcessId = ipcProcessId;
  }

  void
  ExtendedIPCManager::setIPCManagerPort(unsigned int ipcManagerPort)
  {
    this->ipcManagerPort = ipcManagerPort;
  }

  void
  ExtendedIPCManager::notifyIPCProcessInitialized(
      const ApplicationProcessNamingInformation& name) throw (IPCException)
  {
    lock();
  ...
  bool
  ExtendedIPCManager::isIPCProcessInitialized() const
  {
    return ipcProcessInitialized;
  }

  ApplicationRegistration *
  ExtendedIPCManager::appRegistered(
          ...
          throw (ApplicationRegistrationException)
  {
    ...
    applicationRegistration = getApplicationRegistration(appName);

    if (!applicationRegistration)
      {
        applicationRegistration = new ApplicationRegistration(appName);
        putApplicationRegistration(appName, applicationRegistration);
      }
  ...
  void
  ExtendedIPCManager::appUnregistered(
      const ApplicationProcessNamingInformation& appName,
      const ApplicationProcessNamingInformation& DIFName)
          throw (ApplicationUnregistrationException)
  {
    ...
    for (iterator = applicationRegistration->getDIFNames().begin();
        iterator != applicationRegistration->getDIFNames().end(); ++iterator)
      {
        if (*iterator == DIFName)
          {
  ...
  void
  ExtendedIPCManager::assignToDIFResponse(const AssignToDIFRequestEvent& event,
      int result) throw (AssignToDIFResponseException)
  {
    if (result == 0)
      {
  ...
  void
  ExtendedIPCManager::enrollToDIFResponse(const EnrollToDIFRequestEvent& event,
      int result, const std::list<Neighbor> & newNeighbors,
      const DIFInformation& difInformation) throw (EnrollException)
  {
#if STUB_API
    // Do nothing
  ...
  void
  ExtendedIPCManager::notifyNeighborsModified(bool added,
      const std::list<Neighbor> & neighbors) throw (EnrollException)
  {
#if STUB_API
    // Do nothing
  ...
  void
  ExtendedIPCManager::allocateFlowRequestResult(const FlowRequestEvent& event,
      int result) throw (AllocateFlowResponseException)
  {
#if STUB_API
    // Do nothing
  ...
  unsigned int
  ExtendedIPCManager::allocateFlowRequestArrived(
      const ApplicationProcessNamingInformation& localAppName,
      const ApplicationProcessNamingInformation& remoteAppName,
      const FlowSpecification& flowSpecification, int portId)
  ...
  unsigned int
  ExtendedIPCManager::requestFlowAllocation(
      const ApplicationProcessNamingInformation& localAppName,
      const ApplicationProcessNamingInformation& remoteAppName,
      const FlowSpecification& flowSpec) throw (FlowAllocationException)
  {
    return internalRequestFlowAllocation(localAppName, remoteAppName, flowSpec,
        ipcProcessId);
  }

  unsigned int
  ExtendedIPCManager::requestFlowAllocationInDIF(
      const ApplicationProcessNamingInformation& localAppName,
      const ApplicationProcessNamingInformation& remoteAppName,
      const ApplicationProcessNamingInformation& difName,
      const FlowSpecification& flowSpec) throw (FlowAllocationException)
  ...
  ExtendedIPCManager::allocateFlowResponse(
      const FlowRequestEvent& flowRequestEvent, int result, bool notifySource)
          throw (FlowAllocationException)
  {
    return internalAllocateFlowResponse(flowRequestEvent, result, notifySource,
        ipcProcessId);
  }

  void
  ExtendedIPCManager::notifyflowDeallocated(
      const FlowDeallocateRequestEvent flowDeallocateEvent, int result)
  ...
  void
  ExtendedIPCManager::flowDeallocatedRemotely(int portId, int code)
      throw (DeallocateFlowResponseException)
  {
#if STUB_API
    // Do nothing
  ...
  void
  ExtendedIPCManager::queryRIBResponse(const QueryRIBRequestEvent& event,
      int result, const std::list<RIBObject>& ribObjects)
    ...
    try
      {
        ...
        rinaManager->sendMessageOfMaxSize(&responseMessage, 5 * PAGE_SIZE);
      }
    catch (NetlinkException &e)
      {
  ...
  int
  ExtendedIPCManager::allocatePortId(
      const ApplicationProcessNamingInformation& appName)
  ...
  void
  ExtendedIPCManager::deallocatePortId(int portId)
      throw (PortAllocationException)
  {
#if STUB_API
    // Do nothing
  ...
  const std::string&
  PolicyParameter::getName() const
  {
    return name;
  }

  void
  PolicyParameter::setName(const std::string& name)
  {
    this->name = name;
  }

  const std::string&
  PolicyParameter::getValue() const
  {
    return value;
  }

  void
  PolicyParameter::setValue(const std::string& value)
  {
    this->value = value;
  }
  ...
  const std::string&
  EFCPPolicyConfig::getName() const
  {
    return name;
  }

  void
  EFCPPolicyConfig::setName(const std::string& name)
  {
    this->name = name;
  }
  ...
  void
  EFCPPolicyConfig::setParameters(const std::list<PolicyParameter>& parameters)
  {
    this->parameters = parameters;
  }

  void
  EFCPPolicyConfig::addParameter(const PolicyParameter& paremeter)
  {
    parameters.push_back(paremeter);
  }

  short
  EFCPPolicyConfig::getVersion() const
  {
    return version;
  }

  void
  EFCPPolicyConfig::setVersion(short version)
  {
  ...
  int
  DTCPWindowBasedFlowControlConfig::getInitialcredit() const
  {
    return initialcredit;
  }

  void
  DTCPWindowBasedFlowControlConfig::setInitialcredit(int initialcredit)
  {
    this->initialcredit = initialcredit;
  }

  int
  DTCPWindowBasedFlowControlConfig::getMaxclosedwindowqueuelength() const
  {
    return maxclosedwindowqueuelength;
  }

  void
  DTCPWindowBasedFlowControlConfig::setMaxclosedwindowqueuelength(
  ...
  void
  DTCPWindowBasedFlowControlConfig::setRcvrflowcontrolpolicy(
  ...
  void
  DTCPWindowBasedFlowControlConfig::setReceivingflowcontrolpolicy(
  ...
  void
  DTCPRateBasedFlowControlConfig::setNooverridedefaultpeakpolicy(
  ...
  void
  DTCPRateBasedFlowControlConfig::setNorateslowdownpolicy(
  ...
  void
  DTCPRateBasedFlowControlConfig::setRatereductionpolicy(
  ...
  int
  DTCPRateBasedFlowControlConfig::getSendingrate() const
  {
    return sendingrate;
  }

  void
  DTCPRateBasedFlowControlConfig::setSendingrate(int sendingrate)
  {
    this->sendingrate = sendingrate;
  }

  int
  DTCPRateBasedFlowControlConfig::getTimeperiod() const
  {
    return timeperiod;
  }

  void
  DTCPRateBasedFlowControlConfig::setTimeperiod(int timeperiod)
  {
  ...
  const EFCPPolicyConfig&
  DTCPFlowControlConfig::getClosedwindowpolicy() const
  {
    return closedwindowpolicy;
  }

  void
  DTCPFlowControlConfig::setClosedwindowpolicy(
  ...
  void
  DTCPFlowControlConfig::setFlowcontroloverrunpolicy(
  ...
  bool
  DTCPFlowControlConfig::isRatebased() const
  {
    return ratebased;
  }

  void
  DTCPFlowControlConfig::setRatebased(bool ratebased)
  {
  ...
  void
  DTCPFlowControlConfig::setRatebasedconfig(
  ...
  int
  DTCPFlowControlConfig::getRcvbuffersthreshold() const
  {
    return rcvbuffersthreshold;
  }

  void
  DTCPFlowControlConfig::setRcvbuffersthreshold(int rcvbuffersthreshold)
  {
    this->rcvbuffersthreshold = rcvbuffersthreshold;
  }

  int
  DTCPFlowControlConfig::getRcvbytespercentthreshold() const
  {
    return rcvbytespercentthreshold;
  }

  void
  DTCPFlowControlConfig::setRcvbytespercentthreshold(
  ...
  int
  DTCPFlowControlConfig::getRcvbytesthreshold() const
  {
    return rcvbytesthreshold;
  }

  void
  DTCPFlowControlConfig::setRcvbytesthreshold(int rcvbytesthreshold)
  {
  ...
  void
  DTCPFlowControlConfig::setReconcileflowcontrolpolicy(
  ...
  int
  DTCPFlowControlConfig::getSentbuffersthreshold() const
  {
    return sentbuffersthreshold;
  }

  void
  DTCPFlowControlConfig::setSentbuffersthreshold(int sentbuffersthreshold)
  {
    this->sentbuffersthreshold = sentbuffersthreshold;
  }

  int
  DTCPFlowControlConfig::getSentbytespercentthreshold() const
  {
    return sentbytespercentthreshold;
  }

  void
  DTCPFlowControlConfig::setSentbytespercentthreshold(
  ...
  int
  DTCPFlowControlConfig::getSentbytesthreshold() const
  {
    return sentbytesthreshold;
  }

  void
  DTCPFlowControlConfig::setSentbytesthreshold(int sentbytesthreshold)
  {
    this->sentbytesthreshold = sentbytesthreshold;
  }

  bool
  DTCPFlowControlConfig::isWindowbased() const
  {
    return windowbased;
  }

  void
  DTCPFlowControlConfig::setWindowbased(bool windowbased)
  {
  ...
  void
  DTCPFlowControlConfig::setWindowbasedconfig(
  ...
  int
  DTCPRtxControlConfig::getDatarxmsnmax() const
  {
    return datarxmsnmax;
  }

  void
  DTCPRtxControlConfig::setDatarxmsnmax(int datarxmsnmax)
  {
    this->datarxmsnmax = datarxmsnmax;
  }

  int
  DTCPRtxControlConfig::getInitialATimer() const
  {
    return initialATimer;
  }

  void
  DTCPRtxControlConfig::setInitialATimer(int initialATimer)
  {
    this->initialATimer = initialATimer;
  }

  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getRcvrackpolicy() const
  {
    return rcvrackpolicy;
  }

  void
  DTCPRtxControlConfig::setRcvrackpolicy(const EFCPPolicyConfig& rcvrackpolicy)
  {
    this->rcvrackpolicy = rcvrackpolicy;
  }

  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getRcvrcontrolackpolicy() const
  {
    return rcvrcontrolackpolicy;
  }

  void
  DTCPRtxControlConfig::setRcvrcontrolackpolicy(
  ...
  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getRecvingacklistpolicy() const
  {
    return recvingacklistpolicy;
  }

  void
  DTCPRtxControlConfig::setRecvingacklistpolicy(
  ...
  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getRttestimatorpolicy() const
  {
    return rttestimatorpolicy;
  }

  void
  DTCPRtxControlConfig::setRttestimatorpolicy(
  ...
  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getRtxtimerexpirypolicy() const
  {
    return rtxtimerexpirypolicy;
  }

  void
  DTCPRtxControlConfig::setRtxtimerexpirypolicy(
  ...
  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getSenderackpolicy() const
  {
    return senderackpolicy;
  }

  void
  DTCPRtxControlConfig::setSenderackpolicy(
  ...
  const EFCPPolicyConfig&
  DTCPRtxControlConfig::getSendingackpolicy() const
  {
    return sendingackpolicy;
  }

  void
  DTCPRtxControlConfig::setSendingackpolicy(
  ...
  bool
  DTCPConfig::isFlowcontrol() const
  {
    return flowcontrol;
  }

  void
  DTCPConfig::setFlowcontrol(bool flowcontrol)
  {
    this->flowcontrol = flowcontrol;
  }

  const DTCPFlowControlConfig&
  DTCPConfig::getFlowcontrolconfig() const
  {
    return flowcontrolconfig;
  }

  void
  DTCPConfig::setFlowcontrolconfig(
  ...
  int
  DTCPConfig::getInitialrecvrinactivitytime() const
  {
    return initialrecvrinactivitytime;
  }

  void
  DTCPConfig::setInitialrecvrinactivitytime(int initialrecvrinactivitytime)
  {
    this->initialrecvrinactivitytime = initialrecvrinactivitytime;
  }

  int
  DTCPConfig::getInitialsenderinactivitytime() const
  {
    return initialsenderinactivitytime;
  }

  void
  DTCPConfig::setInitialsenderinactivitytime(int initialsenderinactivitytime)
  {
    this->initialsenderinactivitytime = initialsenderinactivitytime;
  }

  const EFCPPolicyConfig&
  DTCPConfig::getInitialseqnumpolicy() const
  {
    return initialseqnumpolicy;
  }

  void
  DTCPConfig::setInitialseqnumpolicy(
  ...
  const EFCPPolicyConfig&
  DTCPConfig::getLostcontrolpdupolicy() const
  {
    return lostcontrolpdupolicy;
  }

  void
  DTCPConfig::setLostcontrolpdupolicy(
  ...
  const EFCPPolicyConfig&
  DTCPConfig::getRcvrtimerinactivitypolicy() const
  {
    return rcvrtimerinactivitypolicy;
  }

  void
  DTCPConfig::setRcvrtimerinactivitypolicy(
  ...
  bool
  DTCPConfig::isRtxcontrol() const
  {
    return rtxcontrol;
  }

  void
  DTCPConfig::setRtxcontrol(bool rtxcontrol)
  {
    this->rtxcontrol = rtxcontrol;
  }

  const DTCPRtxControlConfig&
  DTCPConfig::getRtxcontrolconfig() const
  {
    return rtxcontrolconfig;
  }

  void
  DTCPConfig::setRtxcontrolconfig(const DTCPRtxControlConfig& rtxcontrolconfig)
  {
    this->rtxcontrolconfig = rtxcontrolconfig;
  }

  const EFCPPolicyConfig&
  DTCPConfig::getSendertimerinactiviypolicy() const
  {
    return sendertimerinactiviypolicy;
  }

  void
  DTCPConfig::setSendertimerinactiviypolicy(
  ...
  const DTCPConfig&
  ConnectionPolicies::getDtcpConfiguration() const
  {
    return dtcpConfiguration;
  }

  void
  ConnectionPolicies::setDtcpConfiguration(const DTCPConfig& dtcpConfiguration)
  {
    this->dtcpConfiguration = dtcpConfiguration;
  }

  bool
  ConnectionPolicies::isDtcPpresent() const
  {
    return DTCPpresent;
  }

  void
  ConnectionPolicies::setDtcPpresent(bool dtcPpresent)
  {
    DTCPpresent = dtcPpresent;
  }

  int
  ConnectionPolicies::getSeqnumrolloverthreshold() const
  {
    return seqnumrolloverthreshold;
  }

  void
  ConnectionPolicies::setSeqnumrolloverthreshold(int seqnumrolloverthreshold)
  {
  ...
  unsigned int
  Connection::getDestAddress() const
  {
    return destAddress;
  }

  void
  Connection::setDestAddress(unsigned int destAddress)
  {
    this->destAddress = destAddress;
  }

  int
  Connection::getPortId() const
  {
    return portId;
  }

  void
  Connection::setPortId(int portId)
  {
    this->portId = portId;
  }

  unsigned int
  Connection::getQosId() const
  {
    return qosId;
  }

  void
  Connection::setQosId(unsigned int qosId)
  {
    this->qosId = qosId;
  }

  unsigned int
  Connection::getSourceAddress() const
  {
    return sourceAddress;
  }

  void
  Connection::setSourceAddress(unsigned int sourceAddress)
  {
    this->sourceAddress = sourceAddress;
  }

  int
  Connection::getDestCepId() const
  {
    return destCepId;
  }

  void
  Connection::setDestCepId(int destCepId)
  {
    this->destCepId = destCepId;
  }

  unsigned short
  Connection::getFlowUserIpcProcessId() const
  {
    return flowUserIpcProcessId;
  }

  void
  Connection::setFlowUserIpcProcessId(unsigned short flowUserIpcProcessId)
  {
    this->flowUserIpcProcessId = flowUserIpcProcessId;
  }

  int
  Connection::getSourceCepId() const
  {
    return sourceCepId;
  }

  void
  Connection::setSourceCepId(int sourceCepId)
  {
    this->sourceCepId = sourceCepId;
  }
  ...
  bool
  PDUForwardingTableEntry::operator==(
  ...
  unsigned int
  PDUForwardingTableEntry::getAddress() const
  {
    return address;
  }

  void
  PDUForwardingTableEntry::setAddress(unsigned int address)
  {
    this->address = address;
  }

  const std::list<unsigned int>
  PDUForwardingTableEntry::getPortIds() const
  {
    return portIds;
  }

  void
  PDUForwardingTableEntry::setPortIds(const std::list<unsigned int>& portIds)
  {
    this->portIds = portIds;
  }

  void
  PDUForwardingTableEntry::addPortId(unsigned int portId)
  {
    portIds.push_back(portId);
  }

  unsigned int
  PDUForwardingTableEntry::getQosId() const
  {
    return qosId;
  }

  void
  PDUForwardingTableEntry::setQosId(unsigned int qosId)
  {
    this->qosId = qosId;
  }

  const std::string
  PDUForwardingTableEntry::toString()
  {
    std::stringstream ss;
  ...
  int
  ReadManagementSDUResult::getBytesRead() const
  {
    return bytesRead;
  }

  void
  ReadManagementSDUResult::setBytesRead(int bytesRead)
  {
    this->bytesRead = bytesRead;
  }

  int
  ReadManagementSDUResult::getPortId() const
  {
    return portId;
  }

  void
  ReadManagementSDUResult::setPortId(int portId)
  {
    this->portId = portId;
  }
  ...
  void
  KernelIPCProcess::setIPCProcessId(unsigned short ipcProcessId)
  {
    this->ipcProcessId = ipcProcessId;
  }

  unsigned short
  KernelIPCProcess::getIPCProcessId() const
  {
    return ipcProcessId;
  }

  unsigned int
  KernelIPCProcess::assignToDIF(const DIFInformation& difInformation)
  ...
  unsigned int
  KernelIPCProcess::updateDIFConfiguration(
  ...
  unsigned int
  KernelIPCProcess::createConnection(const Connection& connection)
  ...
  unsigned int
  KernelIPCProcess::updateConnection(const Connection& connection)
  ...
  void
  KernelIPCProcess::modifyPDUForwardingTableEntries(
      const std::list<PDUForwardingTableEntry>& entries, int mode)
  ...
  unsigned int
  KernelIPCProcess::dumptPDUFT() throw (PDUForwardingTableException)
  {
    unsigned int seqNum = 0;
  ...
  void
  KernelIPCProcess::writeManagementSDU(void * sdu, int size, int portId)
      throw (WriteSDUException)
  {
    ...
    (void) portId;
#else
    int result = syscallWriteManagementSDU(ipcProcessId, sdu, portId, size);
    if (result < 0)
      {
        throw WriteSDUException();
      }
  ...
  KernelIPCProcess::readManagementSDU(void * sdu, int maxBytes)
...
#else
    int portId = 0;
    int result = syscallReadManagementSDU(ipcProcessId, sdu, &portId, maxBytes);
    if (result < 0)
      {
        throw ReadSDUException();
      }
  ...
  ADataUnitPDU::ADataUnitPDU(long sourceAddress, long destinationAddress,
      char payload[])
  {
    this->sourceAddress = sourceAddress;
  ...
  long
  ADataUnitPDU::getSourceAddress() const
  {
    return sourceAddress;
  }

  void
  ADataUnitPDU::setSourceAddress(const long sourceAddress)
  {
    this->sourceAddress = sourceAddress;
  }

  long
  ADataUnitPDU::getDestinationAddress() const
  {
    return destinationAddress;
  }

  void
  ADataUnitPDU::setDestinationAddress(const long destinationAddress)
  {
    this->destinationAddress = destinationAddress;
  }

  char*
  ADataUnitPDU::getPayload() const
  {
    return payload;
  }

  void
  ADataUnitPDU::setPayload(char payload[])
  {
    this->payload = payload;
  }

  /*	CLASS WhatevercastName	*/
  const std::string WhatevercastName::WHATEVERCAST_NAME_SET_RIB_OBJECT_NAME =
      RIBObjectNames::SEPARATOR + RIBObjectNames::DAF
          + RIBObjectNames::SEPARATOR + RIBObjectNames::MANAGEMENT
          + RIBObjectNames::SEPARATOR + RIBObjectNames::NAMING
          + RIBObjectNames::SEPARATOR + RIBObjectNames::WHATEVERCAST_NAMES;
  const std::string WhatevercastName::WHATEVERCAST_NAME_SET_RIB_OBJECT_CLASS =
      "whatname set";
  const std::string WhatevercastName::WHATEVERCAST_NAME_RIB_OBJECT_CLASS =
      "whatname";
  const std::string WhatevercastName::DIF_NAME_WHATEVERCAST_RULE = "any";

  std::string
  WhatevercastName::getName() const
  {
    return name;
  }

  void
  WhatevercastName::setName(std::string name)
  {
    this->name = name;
  }

  std::string
  WhatevercastName::getRule() const
  {
    return rule;
  }

  void
  WhatevercastName::setRule(std::string rule)
  {
    this->rule = rule;
  }

  const std::list<char*>&
  WhatevercastName::getSetMembers() const
  {
    return setMembers;
  }

  void
  WhatevercastName::setSetMembers(const std::list<char*> &setMembers)
  {
    this->setMembers = setMembers;
  }

  bool
  WhatevercastName::operator==(const WhatevercastName &other)
  {
  ...
  const std::string EnrollmentInformationRequest::ENROLLMENT_INFO_OBJECT_NAME =
      RIBObjectNames::SEPARATOR + RIBObjectNames::DAF
          + RIBObjectNames::SEPARATOR + RIBObjectNames::MANAGEMENT
  ...
  unsigned int
  EnrollmentInformationRequest::getAddress() const
  {
    return address;
  }

  void
  EnrollmentInformationRequest::setAddress(unsigned int address)
  {
    this->address = address;
  }

  const std::list<ApplicationProcessNamingInformation>&
  EnrollmentInformationRequest::getSupportingDifs() const
  {
    return supportingDifs;
  }

  void
  EnrollmentInformationRequest::setSupportingDifs(
  ...
  EnrollmentRequest::EnrollmentRequest(const Neighbor &arg0,
      const EnrollToDIFRequestEvent &arg1)
  {
    neighbor = arg0;
    event = arg1;
  }
  ...
  const Neighbor&
  EnrollmentRequest::getNeighbor() const
  {
    return neighbor;
  }

  void
  EnrollmentRequest::setNeighbor(const Neighbor &arg0)
  {
    neighbor = arg0;
  }

  const EnrollToDIFRequestEvent&
  EnrollmentRequest::getEvent() const
  {
    return event;
  }

  void
  EnrollmentRequest::setEvent(const EnrollToDIFRequestEvent &arg0)
  {
    event = arg0;
  }

  /*	CLASS BaseEvent	*/
  const std::string BaseEvent::CONNECTIVITY_TO_NEIGHBOR_LOST =
      "Connectivity to Neighbor Lost";
  const std::string BaseEvent::EFCP_CONNECTION_CREATED =
      "EFCP Connection Created";
  const std::string BaseEvent::EFCP_CONNECTION_DELETED =
      "EFCP Connection Deleted";
  const std::string BaseEvent::MANAGEMENT_FLOW_ALLOCATED =
      "Management Flow Allocated";
  const std::string BaseEvent::MANAGEMENT_FLOW_DEALLOCATED =
      "Management Flow Deallocated";
  const std::string BaseEvent::N_MINUS_1_FLOW_ALLOCATED =
      "N minus 1 Flow Allocated";
  const std::string BaseEvent::N_MINUS_1_FLOW_ALLOCATION_FAILED =
      "N minus 1 Flow Allocation Failed";
  const std::string BaseEvent::N_MINUS_1_FLOW_DEALLOCATED =
      "N minus 1 Flow Deallocated";
  ...
  DirectoryForwardingTableEntry::getApNamingInfo() const
  {
    return apNamingInfo;
  }
  ...
  DirectoryForwardingTableEntry::setApNamingInfo(
      const ApplicationProcessNamingInformation &apNamingInfo)
  {
    this->apNamingInfo = apNamingInfo;
  }

  long
  DirectoryForwardingTableEntry::getAddress() const
  {
    return address;
  }

  void
  DirectoryForwardingTableEntry::setAddress(long address)
  {
    this->address = address;
  }

  long
  DirectoryForwardingTableEntry::getTimestamp() const
  {
    return timestamp;
  }

  void
  DirectoryForwardingTableEntry::setTimestamp(long timestamp)
  {
    this->timestamp = timestamp;
  }

  std::string
  DirectoryForwardingTableEntry::getKey()
  {
    return this->apNamingInfo.getEncodedString();
  }

  bool
  DirectoryForwardingTableEntry::operator==(
      const DirectoryForwardingTableEntry &object)
  {
  ...
  std::string
  DirectoryForwardingTableEntry::toString()
  {
    std::stringstream ss;
  ...
  const std::string IPCPFlow::FLOW_SET_RIB_OBJECT_NAME =
      RIBObjectNames::SEPARATOR + RIBObjectNames::DIF
          + RIBObjectNames::SEPARATOR + RIBObjectNames::RESOURCE_ALLOCATION
          + RIBObjectNames::SEPARATOR + RIBObjectNames::FLOW_ALLOCATOR
          + RIBObjectNames::SEPARATOR + RIBObjectNames::FLOWS;
  ...
  bool
  IPCPFlow::isSource() const
  {
    return source;
  }

  void
  IPCPFlow::setSource(bool source)
  {
    this->source = source;
  }

  const ApplicationProcessNamingInformation&
  IPCPFlow::getSourceNamingInfo() const
  {
    return sourceNamingInfo;
  }

  void
  IPCPFlow::setSourceNamingInfo(
      const ApplicationProcessNamingInformation &sourceNamingInfo)
  {
    this->sourceNamingInfo = sourceNamingInfo;
  }

  const ApplicationProcessNamingInformation&
  IPCPFlow::getDestinationNamingInfo() const
  {
    return destinationNamingInfo;
  }

  void
  IPCPFlow::setDestinationNamingInfo(
      const ApplicationProcessNamingInformation &destinationNamingInfo)
  {
    this->destinationNamingInfo = destinationNamingInfo;
  }

  int
  IPCPFlow::getSourcePortId() const
  {
    return sourcePortId;
  }

  void
  IPCPFlow::setSourcePortId(int sourcePortId)
  {
    this->sourcePortId = sourcePortId;
  }

  int
  IPCPFlow::getDestinationPortId() const
  {
    return destinationPortId;
  }

  void
  IPCPFlow::setDestinationPortId(int destinationPortId)
  {
    this->destinationPortId = destinationPortId;
  }

  long
  IPCPFlow::getSourceAddress() const
  {
    return sourceAddress;
  }

  void
  IPCPFlow::setSourceAddress(long sourceAddress)
  {
    this->sourceAddress = sourceAddress;
  }

  long
  IPCPFlow::getDestinationAddress() const
  {
    return destinationAddress;
  }

  void
  IPCPFlow::setDestinationAddress(long destinationAddress)
  {
    this->destinationAddress = destinationAddress;
  }

  const std::list<Connection>&
  IPCPFlow::getConnections() const
  {
    return connections;
  }

  void
  IPCPFlow::setConnections(const std::list<Connection> &connections)
  {
    this->connections = connections;
  }

  int
  IPCPFlow::getCurrentConnectionIndex() const
  {
    return currentConnectionIndex;
  }

  void
  IPCPFlow::setCurrentConnectionIndex(int currentConnectionIndex)
  {
    this->currentConnectionIndex = currentConnectionIndex;
  }

  IPCPFlow::IPCPFlowState
  IPCPFlow::getState() const
  {
    return state;
  }

  void
  IPCPFlow::setState(IPCPFlowState state)
  {
    this->state = state;
  }

  const FlowSpecification&
  IPCPFlow::getFlowSpecification() const
  {
    return flowSpec;
  }

  void
  IPCPFlow::setFlowSpecification(const FlowSpecification &flowSpec)
  {
    this->flowSpec = flowSpec;
  }

  const std::map<std::string, std::string>&
  IPCPFlow::getPolicies() const
  {
    return policies;
  }

  void
  IPCPFlow::setPolicies(const std::map<std::string, std::string> &policies)
  {
    this->policies = policies;
  }

  const std::map<std::string, std::string>&
  IPCPFlow::getPolicyParameters() const
  {
    return policyParameters;
  }

  void
  IPCPFlow::setPolicyParameters(
      const std::map<std::string, std::string> &policyParameters)
  {
    this->policyParameters = policyParameters;
  }

  char*
  IPCPFlow::getAccessControl() const
  {
    return accessControl;
  }

  void
  IPCPFlow::setAccessControl(char* accessControl)
  {
    this->accessControl = accessControl;
  }

  int
  IPCPFlow::getMaxCreateFlowRetries() const
  {
    return maxCreateFlowRetries;
  }

  void
  IPCPFlow::setMaxCreateFlowRetries(int maxCreateFlowRetries)
  {
    this->maxCreateFlowRetries = maxCreateFlowRetries;
  }

  int
  IPCPFlow::getCreateFlowRetries() const
  {
    return createFlowRetries;
  }

  void
  IPCPFlow::setCreateFlowRetries(int createFlowRetries)
  {
    this->createFlowRetries = createFlowRetries;
  }

  int
  IPCPFlow::getHopCount() const
  {
    return hopCount;
  }

  void
  IPCPFlow::setHopCount(int hopCount)
  {
  ...
  IPCPFlow::toString()
  {
    ...
    ss << "* Is this IPC Process the requestor of the flow? " << this->source
        << std::endl;
    ss << "* Max create flow retries: " << this->maxCreateFlowRetries
        << std::endl;
    ss << "* Hop count: " << this->hopCount << std::endl;
    ss << "* Source AP Naming Info: " << this->sourceNamingInfo.toString()
        << std::endl;
    ;
    ss << "* Source address: " << this->sourceAddress << std::endl;
    ss << "* Source port id: " << this->sourcePortId << std::endl;
    ss << "* Destination AP Naming Info: "
        << this->destinationNamingInfo.toString();
    ...
    if (!this->policyParameters.empty())
      {
        ...
        for (std::map<std::string, std::string>::const_iterator iterator =
            policyParameters.begin(), end = policyParameters.end();
