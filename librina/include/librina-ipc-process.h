...
namespace rina
{
  ...
  public:
    UpdateDIFConfigurationRequestEvent(const DIFConfiguration& difConfiguration,
        unsigned int sequenceNumber);
    const DIFConfiguration&
    getDIFConfiguration() const;
  };
  ...
  public:
    ...
    EnrollToDIFRequestEvent(const ApplicationProcessNamingInformation& difName,
  ...
  public:
    CreateConnectionResultEvent(int portId, int sourceCepId, int destCepId,
        unsigned int sequenceNumber);
    int
    getSourceCepId() const;
    int
    getDestCepId() const;
    int
    getPortId() const;
  ...
  public:
    AssignToDIFResponseException() :
        IPCException(
            "Problems informing the IPC Manager about the result of an assign to DIF operation")
    {
    }
  ...
  public:
    RegisterApplicationResponseException() :
        IPCException(
            "Problems informing the IPC Manager about the result of a register application response operation")
    {
    }
  ...
  public:
    UnregisterApplicationResponseException() :
        IPCException(
            "Problems informing the IPC Manager about the result of an unegister application response operation")
    {
    }
  ...
  public:
    QueryRIBResponseException() :
        IPCException(
            "Problems informing the IPC Manager about the result of a query RIB response operation")
    {
    }
  ...
  public:
    DeallocateFlowResponseException() :
        IPCException(
            "Problems informing the application about the result of a deallocate operation")
    {
    }
  ...
  public:
    PortAllocationException() :
        IPCException(
            "Problems requesting the allocation/deallocation of a port-id")
    {
    }
  ...
  public:
    ...
    const DIFInformation&
    getCurrentDIFInformation() const;
    void
    setCurrentDIFInformation(const DIFInformation& currentDIFInformation);
    unsigned short
    getIpcProcessId() const;
    void
    setIpcProcessId(unsigned short ipcProcessId);
    void
    setIPCManagerPort(unsigned int ipcManagerPort);
     ...
     */
    void
    notifyIPCProcessInitialized(const ApplicationProcessNamingInformation& name)
        throw (IPCException);
    ...
    appRegistered(const ApplicationProcessNamingInformation& appName,
     ...
     */
    void
    appUnregistered(const ApplicationProcessNamingInformation& appName,
        const ApplicationProcessNamingInformation& DIFName)
     ...
     */
    void
    assignToDIFResponse(const AssignToDIFRequestEvent& event, int result)
     ...
     */
    void
    enrollToDIFResponse(const EnrollToDIFRequestEvent& event, int result,
     ...
     */
    void
    notifyNeighborsModified(bool added, const std::list<Neighbor> & neighbors)
     ...
     */
    void
    allocateFlowRequestResult(const FlowRequestEvent& event, int result)
     ...
     */
    Flow *
    allocateFlowResponse(const FlowRequestEvent& flowRequestEvent, int result,
     ...
     */
    void
    notifyflowDeallocated(const FlowDeallocateRequestEvent flowDeallocateEvent,
        int result) throw (DeallocateFlowResponseException);
     ...
     */
    void
    flowDeallocatedRemotely(int portId, int code)
     ...
     */
    void
    queryRIBResponse(const QueryRIBRequestEvent& event, int result,
     ...
     */
    int
    allocatePortId(const ApplicationProcessNamingInformation& appName)
     ...
     */
    void
    deallocatePortId(int portId) throw (PortAllocationException);
  };
  ...
  public:
    ...
    getParameters() const;
    void
    setParameters(const std::list<PolicyParameter>& parameters);
    void
    addParameter(const PolicyParameter& paremeter);
    short
    getVersion() const;
    void
  ...
  public:
    ...
    int
    getInitialcredit() const;
    void
    setInitialcredit(int initialcredit);
    int
    getMaxclosedwindowqueuelength() const;
    void
    setMaxclosedwindowqueuelength(int maxclosedwindowqueuelength);
    const EFCPPolicyConfig&
    getRcvrflowcontrolpolicy() const;
    void
    setRcvrflowcontrolpolicy(const EFCPPolicyConfig& rcvrflowcontrolpolicy);
    const EFCPPolicyConfig&
    getReceivingflowcontrolpolicy() const;
    void
    setReceivingflowcontrolpolicy(
  ...
  public:
    ...
    const EFCPPolicyConfig&
    getNooverridedefaultpeakpolicy() const;
    void
    setNooverridedefaultpeakpolicy(
        const EFCPPolicyConfig& nooverridedefaultpeakpolicy);
    const EFCPPolicyConfig&
    getNorateslowdownpolicy() const;
    void
    setNorateslowdownpolicy(const EFCPPolicyConfig& norateslowdownpolicy);
    const EFCPPolicyConfig&
    getRatereductionpolicy() const;
    void
    setRatereductionpolicy(const EFCPPolicyConfig& ratereductionpolicy);
    int
    getSendingrate() const;
    void
    setSendingrate(int sendingrate);
    int
    getTimeperiod() const;
    void
  ...
  public:
    ...
    const EFCPPolicyConfig&
    getClosedwindowpolicy() const;
    void
    setClosedwindowpolicy(const EFCPPolicyConfig& closedwindowpolicy);
    const EFCPPolicyConfig&
    getFlowcontroloverrunpolicy() const;
    void
    setFlowcontroloverrunpolicy(
        const EFCPPolicyConfig& flowcontroloverrunpolicy);
    bool
    isRatebased() const;
    void
    setRatebased(bool ratebased);
    const DTCPRateBasedFlowControlConfig&
    getRatebasedconfig() const;
    void
    setRatebasedconfig(const DTCPRateBasedFlowControlConfig& ratebasedconfig);
    int
    getRcvbuffersthreshold() const;
    void
    setRcvbuffersthreshold(int rcvbuffersthreshold);
    int
    getRcvbytespercentthreshold() const;
    void
    setRcvbytespercentthreshold(int rcvbytespercentthreshold);
    int
    getRcvbytesthreshold() const;
    void
    setRcvbytesthreshold(int rcvbytesthreshold);
    const EFCPPolicyConfig&
    getReconcileflowcontrolpolicy() const;
    void
    setReconcileflowcontrolpolicy(
        const EFCPPolicyConfig& reconcileflowcontrolpolicy);
    int
    getSentbuffersthreshold() const;
    void
    setSentbuffersthreshold(int sentbuffersthreshold);
    int
    getSentbytespercentthreshold() const;
    void
    setSentbytespercentthreshold(int sentbytespercentthreshold);
    int
    getSentbytesthreshold() const;
    void
    setSentbytesthreshold(int sentbytesthreshold);
    bool
    isWindowbased() const;
    void
    setWindowbased(bool windowbased);
    const DTCPWindowBasedFlowControlConfig&
    getWindowbasedconfig() const;
    void
    setWindowbasedconfig(
  ...
  public:
    ...
    int
    getDatarxmsnmax() const;
    void
    setDatarxmsnmax(int datarxmsnmax);
    int
    getInitialATimer() const;
    void
    setInitialATimer(int initialATimer);
    const EFCPPolicyConfig&
    getRcvrackpolicy() const;
    void
    setRcvrackpolicy(const EFCPPolicyConfig& rcvrackpolicy);
    const EFCPPolicyConfig&
    getRcvrcontrolackpolicy() const;
    void
    setRcvrcontrolackpolicy(const EFCPPolicyConfig& rcvrcontrolackpolicy);
    const EFCPPolicyConfig&
    getRecvingacklistpolicy() const;
    void
    setRecvingacklistpolicy(const EFCPPolicyConfig& recvingacklistpolicy);
    const EFCPPolicyConfig&
    getRttestimatorpolicy() const;
    void
    setRttestimatorpolicy(const EFCPPolicyConfig& rttestimatorpolicy);
    const EFCPPolicyConfig&
    getRtxtimerexpirypolicy() const;
    void
    setRtxtimerexpirypolicy(const EFCPPolicyConfig& rtxtimerexpirypolicy);
    const EFCPPolicyConfig&
    getSenderackpolicy() const;
    void
    setSenderackpolicy(const EFCPPolicyConfig& senderackpolicy);
    const EFCPPolicyConfig&
    getSendingackpolicy() const;
    void
    setSendingackpolicy(const EFCPPolicyConfig& sendingackpolicy);
  };
  ...
  public:
    ...
    isFlowcontrol() const;
    void
    setFlowcontrol(bool flowcontrol);
    const DTCPFlowControlConfig&
    getFlowcontrolconfig() const;
    void
    setFlowcontrolconfig(const DTCPFlowControlConfig& flowcontrolconfig);
    int
    getInitialrecvrinactivitytime() const;
    void
    setInitialrecvrinactivitytime(int initialrecvrinactivitytime);
    int
    getInitialsenderinactivitytime() const;
    void
    setInitialsenderinactivitytime(int initialsenderinactivitytime);
    const EFCPPolicyConfig&
    getInitialseqnumpolicy() const;
    void
    setInitialseqnumpolicy(const EFCPPolicyConfig& initialseqnumpolicy);
    const EFCPPolicyConfig&
    getLostcontrolpdupolicy() const;
    void
    setLostcontrolpdupolicy(const EFCPPolicyConfig& lostcontrolpdupolicy);
    const EFCPPolicyConfig&
    getRcvrtimerinactivitypolicy() const;
    void
    setRcvrtimerinactivitypolicy(
        const EFCPPolicyConfig& rcvrtimerinactivitypolicy);
    bool
    isRtxcontrol() const;
    void
    setRtxcontrol(bool rtxcontrol);
    const DTCPRtxControlConfig&
    getRtxcontrolconfig() const;
    void
    setRtxcontrolconfig(const DTCPRtxControlConfig& rtxcontrolconfig);
    const EFCPPolicyConfig&
    getSendertimerinactiviypolicy() const;
    void
    setSendertimerinactiviypolicy(
  ...
  public:
    ConnectionPolicies();
    const DTCPConfig&
    getDtcpConfiguration() const;
    void
    setDtcpConfiguration(const DTCPConfig& dtcpConfiguration);
    bool
    isDtcPpresent() const;
    void
    setDtcPpresent(bool dtcPpresent);
    int
    getSeqnumrolloverthreshold() const;
    void
    setSeqnumrolloverthreshold(int seqnumrolloverthreshold);
  };
  ...
  public:
    ...
    void
    setDestAddress(unsigned int destAddress);
    int
    getPortId() const;
    void
    ...
    getQosId() const;
    void
    setQosId(unsigned int qosId);
    unsigned int
    getSourceAddress() const;
    void
    setSourceAddress(unsigned int sourceAddress);
    int
    getDestCepId() const;
    void
    setDestCepId(int destCepId);
    unsigned short
    ...
    void
    setConnPolicies(const ConnectionPolicies& connPParams);
    const std::string
    toString();
  };
  ...
  public:
    ...
    bool
    operator==(const PDUForwardingTableEntry &other) const;
    bool
    operator!=(const PDUForwardingTableEntry &other) const;
    unsigned int
    getAddress() const;
    void
    setAddress(unsigned int address);
    const std::list<unsigned int>
    getPortIds() const;
    void
    setPortIds(const std::list<unsigned int>& portIds);
    void
    addPortId(unsigned int portId);
    unsigned int
    getQosId() const;
    void
    setQosId(unsigned int qosId);
  ...
  public:
     ...
     */
    unsigned int
    assignToDIF(const DIFInformation& difInformation)
     ...
     */
    unsigned int
    updateDIFConfiguration(const DIFConfiguration& difConfiguration)
     ...
     */
    unsigned int
    createConnection(const Connection& connection)
     ...
     */
    unsigned int
    updateConnection(const Connection& connection)
     ...
     */
    void
    modifyPDUForwardingTableEntries(
     ...
     */
    unsigned int
    dumptPDUFT() throw (PDUForwardingTableException);
     ...
     */
    void
    writeManagementSDU(void * sdu, int size, int portId)
     ...
     */
    ReadManagementSDUResult
    readManagementSDU(void * sdu, int maxBytes) throw (ReadSDUException);
  };
  ...
  public:
    ...
    getSourceAddress() const;
    void
    setSourceAddress(long sourceAddress);
    long
    getDestinationAddress() const;
    void
    setDestinationAddress(long destinationAddress);
    char*
    getPayload() const;
    void
    setPayload(char payload[]);
  };
  ...
  public:
    ...
    getRule() const;
    void
    setRule(std::string rule);
    const std::list<char*>&
    getSetMembers() const;
    void
    setSetMembers(const std::list<char*> &setMembers);
    /*	Methods	*/
  public:
    bool
    operator==(const WhatevercastName &other);
    std::string
    toString();
  };
...
//void initializeIPCProcess(unsigned int localPort, const std::string& logLevel, const std::string& pathToLogFile);
  ...
  template<class T>
    ...
    public:
      virtual char*
      encode(const T &object) throw (Exception) = 0;
      virtual T
      decode(const char serializedObject[]) throw (Exception) = 0;
      virtual
      ~IEncoder()
      {
      }
  ...
  protected:
    ...
    /*	Constructors and Destructors	*/
  public:
    EnrollmentRequest(const Neighbor &neighbor,
        const EnrollToDIFRequestEvent &event);
    /*	Accessors	*/
  public:
    const Neighbor&
    getNeighbor() const;
    void
    setNeighbor(const Neighbor &neighbor);
    const EnrollToDIFRequestEvent&
    getEvent() const;
    void
    setEvent(const EnrollToDIFRequestEvent &event);
  };
  ...
  public:
    virtual void
    setIPCProcess(const IPCProcess &ipcProcess) = 0;
    virtual
    ~IPCProcessComponent()
    {
    }
  ...
  public:
     ...
     */
    virtual void
    subscribeToEvent(std::string eventId,
        const EventListener &eventListener) = 0;
    /**
     ...
     */
    virtual void
    subscribeToEvents(const std::list<std::string> &eventIds,
        const EventListener &eventListener) = 0;
    /**
     ...
     */
    virtual void
    unsubscribeFromEvent(std::string eventId,
        const EventListener &eventListener) = 0;
    /**
     ...
     */
    virtual void
    unsubscribeFromEvents(const std::list<std::string> &eventIds,
        const EventListener &eventListener) = 0;
    /**
     ...
     */
    virtual void
    deliverEvent(const Event &event) = 0;
  };
  ...
  public:
    ...
    getApNamingInfo() const;
    void
    setApNamingInfo(const ApplicationProcessNamingInformation &apNamingInfo);
    long
    getAddress() const;
    void
  ...
  public:
    bool
    operator==(const DirectoryForwardingTableEntry &object);
    std::string
    toString();
  };
  ...
  public:
    ...
    isSource() const;
    void
    setSource(bool source);
    const ApplicationProcessNamingInformation&
    getSourceNamingInfo() const;
    void
    setSourceNamingInfo(
        const ApplicationProcessNamingInformation &sourceNamingInfo);
    const ApplicationProcessNamingInformation&
    getDestinationNamingInfo() const;
    void
    setDestinationNamingInfo(
        const ApplicationProcessNamingInformation &destinationNamingInfo);
    int
    getSourcePortId() const;
    void
    setSourcePortId(int sourcePortId);
    int
    getDestinationPortId() const;
    void
    setDestinationPortId(int destinationPortId);
    long
    getSourceAddress() const;
    void
    setSourceAddress(long sourceAddress);
    ...
    void
    setConnections(const std::list<Connection> &connections);
    int
    getCurrentConnectionIndex() const;
    void
    setCurrentConnectionIndex(int currentConnectionIndex);
    IPCPFlowState
    getState() const;
    void
    setState(IPCPFlowState state);
    const FlowSpecification&
    getFlowSpecification() const;
    void
    setFlowSpecification(const FlowSpecification &flowSpec);
    const std::map<std::string, std::string>&
    getPolicies() const;
    void
    setPolicies(const std::map<std::string, std::string> &policies);
    const std::map<std::string, std::string>&
    getPolicyParameters() const;
    void
    setPolicyParameters(
    ...
    void
    setAccessControl(char* accessControl);
    int
    getMaxCreateFlowRetries() const;
    void
    setMaxCreateFlowRetries(int maxCreateFlowRetries);
    int
    getCreateFlowRetries() const;
    void
    setCreateFlowRetries(int createFlowRetries);
    int
    getHopCount() const;
    void
  ...
  public:
     ...
     */
    virtual char*
    getDelimitedSdus(const std::list<char*>& rawSdus) = 0;
    /**
     ...
     */
    virtual int
    readVarint32(char byteArray[], int length) = 0;
    /**
    ...
    getRawSdus(char delimitedSdus[]) = 0;
  };
  ...
  public:
    ...
    long virtual
    getNextHop(long destinationAddress) throw (IPCException);

    /** Send a message encapsulated in an A-Data-Unit PDU */
    void virtual
    sendADataUnit(long destinationAddress, const CDAPMessage &cdapMessage,
        const CDAPMessageHandler &cdapMessageHandler) throw (IPCException) = 0;
  };
