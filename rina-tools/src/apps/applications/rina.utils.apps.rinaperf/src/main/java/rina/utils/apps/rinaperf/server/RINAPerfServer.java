...
import rina.utils.apps.rinaperf.utils.FlowAcceptor;
 ...
 *
 */
public class RINAPerfServer implements FlowAcceptor, ApplicationRegistrationListener, FlowDeallocationListener {
	...
	private static final Log log = LogFactory.getLog(RINAPerfServer.class);
	...
	public RINAPerfServer(ApplicationProcessNamingInformation echoApNamingInfo){
		try {
	...
	public synchronized void flowAllocated(Flow flow) {
		...
		RINAPerfServer.executeRunnable(flowReader);
