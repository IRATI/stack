...
static int cas_rcvr_ack(struct dtcp_ps * ps, seq_num_t seq)
{
        printk("%s: called()\n", __func__);
        return 0;
}
...
static int
cas_receiving_flow_control(struct dtcp_ps * ps, seq_num_t seq)
{
        printk("%s: called()\n", __func__);
        return 0;
}
...
static int
cas_rcvr_flow_control(struct dtcp_ps * ps, seq_num_t seq)
{
        printk("%s: called()\n", __func__);
        return 0;
}
